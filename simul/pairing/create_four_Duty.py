...
del flights_df['DepTime']
del flights_df['ArrTime']
del flights_df['DepTz']
del flights_df['ArrTz']

origin_dest=list(zip(flights_df.Origin, flights_df.Dest))
...
df1, df2=assemble_4_flights(b2b_df,b2nb_df,nb2nb_df,nb2b_df)
